...
<head>
  ...
  <!-- Agrega estos enlaces en la sección <head> de tu página -->
 <link rel="stylesheet" href="https://cdn.jsdelivr.net/npm/sweetalert2@11.1.4/dist/sweetalert2.min.css">
 <script src="https://cdn.jsdelivr.net/npm/sweetalert2@11.1.4/dist/sweetalert2.all.min.js"></script>
 <link rel="icon" type="image/png" href="../actividad_cuentas/administrador/img/bank.png">
    <title>Banco </title>
            ...
            <div class="card-body p-md-2">
              ...
              <p class="text-center h1 fw-bold mb-4 mx-1 mx-md-3 mt-3">Sign up</p>
                ...
                <div class="col-md-10 col-lg-6 col-xl-7 d-flex align-items-center order-1 order-lg-2">
                  ...
                  <img src="register.png" class="img-fluid" alt="Sample image" height="300px" width="500px">
